Template.helloworldIndex.helpers({

});

Template.helloworldIndex.events = {
...
/* sorting by parameter */
'click #btnSortage': function(e) {
MeteorisGridView.sort('age');
},
    ...
    'click #btnRemoveAll': function(e) {
        ...
        if (checkedLength > 0) {
            ...
            MeteorisFlash.set('danger', TAPi18n.__("no_selection", "") + ".");
        }
